...
import com.example.jinquan.pan.mnist_ensorflow_androiddemo.Bezier;
import com.example.jinquan.pan.mnist_ensorflow_androiddemo.ControlTimedPoints;
import com.example.jinquan.pan.mnist_ensorflow_androiddemo.TimedPoint;
...
public class SignatureView extends View {
    ...
    public SignatureView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mPaint.setColor(a.getColor(R.styleable.SignatureView_penColor, Color.RED));
        } finally {
            a.recycle();
        }
...
//		mPaint.setTextSize(100);             //绘制文字大小，单位px
    ...
    public void setPenColorRes(int colorRes) {
        try {
            ...
            setPenColor(getResources().getColor(Color.RED));
        }
    }
